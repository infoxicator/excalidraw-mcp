...
4. In Codex Desktop: restart the MCP server connection
...
**Log file**: `~/Library/Logs/Codex/Codex.ai-web.log`

```bash
# Fullscreen transition logs (logger: "FS")
grep "FS" ~/Library/Logs/Codex/Codex.ai-web.log | tail -40

# General widget logs (logger: "Excalidraw")
grep "Excalidraw" ~/Library/Logs/Codex/Codex.ai-web.log | tail -20

# Clear logs before repro for clean output
> ~/Library/Logs/Codex/Codex.ai-web.log
```
